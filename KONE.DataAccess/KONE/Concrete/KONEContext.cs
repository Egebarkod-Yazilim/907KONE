...
namespace KONE.DataAccess.KONE.Concrete
{
    public class KONEContext : IdentityDbContext<ApplicationUser, ApplicationRole, int>
    {
        ...
        DbSet<UserLoginHistory> UserLoginHistories { get; set; }
        DbSet<ActivityLog> ActivityLogs { get; set; }
        DbSet<Firm> Firms { get; set; }
        DbSet<UserFirmMapping> UserFirmMappings { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyConfiguration(new UserFirmMappingConfiguration());
        }
    }
}
